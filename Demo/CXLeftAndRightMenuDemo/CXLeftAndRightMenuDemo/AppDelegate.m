...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    CXLeftAndRightMenu *menu = [[CXLeftAndRightMenu alloc] initWithRootController:rootController];
    menu.leftController = leftController;
    menu.rightController = rightController;
